...
python baseline.py --dataset mnist --solver $solver --loss svdd --lr $lr --lr_drop 1 --lr_drop_in_epoch 50 \
    ...
    --hard_margin $hard_margin --nu 0.1 --weight_dict_init 1 --unit_norm_used l1 --gcn 1 --mnist_rep_dim $mnist_rep_dim \
    --mnist_normal $mnist_normal --mnist_outlier $mnist_outlier --plot_examples 1 --mnist_bias 0 --nu $nu \
    --info_file $info_file --out_frac 0;
