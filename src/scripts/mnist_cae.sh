...
python baseline.py --device $device --xp_dir $xp_dir --dataset mnist --solver $solver --loss autoencoder --lr $lr \
	...
	--leaky_relu 1 --ae_loss l2 --mnist_bias 0 --mnist_rep_dim $mnist_rep_dim --mnist_normal $mnist_normal \
	--mnist_outlier $mnist_outlier --plot_examples 1 --ae_diagnostics 0 --info_file $info_file;
