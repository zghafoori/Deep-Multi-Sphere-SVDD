'''
 ...
 Summary of the changes: 
     1. related calls for DMSVDD (msvdd for short) are added
     2. save_diagnostics is modified by adding more result logs
'''
...
class NeuralNet:
    ...
    def load_data(self, data_loader=None, pretrain=False):
        ...
        elif (Cfg.svdd_loss or Cfg.msvdd_loss) and Cfg.reconstruction_penalty:
            self.data.build_autoencoder(self)
    ...
    def pretrain(self, solver, lr, n_epochs):
        ...
        if (Cfg.svdd_loss or Cfg.msvdd_loss) and Cfg.reconstruction_penalty:
            self.data.build_autoencoder(self)
    ...
    def addConvLayer(self, use_batch_norm=False, activationFlag = True, **kwargs):
        """
    ...
    def addDenseLayer(self, activationFlag=True, use_batch_norm=False, **kwargs):
        """
        Add dense layer.
