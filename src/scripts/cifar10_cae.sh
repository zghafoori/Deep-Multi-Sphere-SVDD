...
python baseline.py --device $device --xp_dir $xp_dir --dataset cifar10 --solver $solver --loss autoencoder --lr $lr \
	...
	--leaky_relu 1 --ae_loss l2 --cifar10_bias 0 --cifar10_rep_dim 128 \
	--cifar10_normal $cifar10_normal --cifar10_outlier $cifar10_outlier --plot_examples 1 --ae_diagnostics 0 --info_file $info_file;
